    ...
    <section class="brand_section layout_padding">
        <div class="container">
            <div class="heading_container">
                <h2>
                    Produk Penjualan Kami
                </h2>
            </div>
            <div class="brand_container layout_padding2">
                <?php foreach ($rs2 as $item) : ?>
                <div class="box">
                    <a href="#formPembelian">
                        <div class="img-box">
                    ...
                    <form action="config/proses.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="nama" name="nama_pelanggan" placeholder="Nama Pembeli" />
                            </div>
                            <div class="col-md-6">
                                <label for="alamat">
                                    <h5><strong>Alamat Pembeli</strong></h5>
                                </label>
                                <input type="text" class="message-box" name="alamat_pelanggan" id="alamat"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="motor">
                                    <h5><strong>Nama Motor</strong></h5>
                                </label>
                                <?php
                $sqljenis = "SELECT * FROM motor";
                $rsjenis = $dbh->query($sqljenis);
                ?>
                                <select id="motor" name="motor_id" class="custom-select">
                                    <?php
                  foreach ($rsjenis as $item) {
                  ?>
                  ...
                  ?>
                            ...
                            <div class="col-md-6">
                                <label for="Kuantitas">
                                    <h5><strong>Kuantitas</strong></h5>
                                </label>
                                <input type="number" name="quantity" id="Kuantitas" placeholder="1" />
                            </div>
                        </div>
                        <div class="d-flex ">
